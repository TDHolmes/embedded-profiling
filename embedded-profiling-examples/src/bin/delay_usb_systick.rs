...
static mut EP_INSTANCE: Option<ep_systick::SysTickProfiler<CORE_FREQ>> = None;
...
fn main() -> ! {
    ...
    let systick_profiler = ep_systick::SysTickProfiler::<CORE_FREQ>::new(core.SYST, CORE_FREQ);
    unsafe {
        EP_INSTANCE = Some(systick_profiler);
